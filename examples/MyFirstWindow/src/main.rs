// imports & compilation WILL not work right now as im doing this in a text file as a mockup
...
// should probably be moved outside main and into some time/utils crate
#[derive(Clone, Debug)]
pub struct Clock {
...
async fn main() -> Result<()> {
  ...
  world.spawn(Tree { render: RenderObject { mesh: tree }, });
